...
class ItemTest(BaseTest):
    ...
    def test_create_item(self):
        with self.app() as c:
            with self.app_context():
                StoreModel('test').save_to_db()
                r = c.post('/item/test', json={'price': 17.99, 'store_id': 1})
    ...
    def test_create_duplicate_item(self):
        with self.app() as c:
            with self.app_context():
                StoreModel('test').save_to_db()
                c.post('/item/test', json={'price': 17.99, 'store_id': 1})
                r = c.post('/item/test', json={'price': 17.99, 'store_id': 1})
    ...
    def test_put_item(self):
        with self.app() as c:
            with self.app_context():
                StoreModel('test').save_to_db()
                r = c.put('/item/test', json={'price': 17.99, 'store_id': 1})
    ...
    def test_put_update_item(self):
        with self.app() as c:
            with self.app_context():
                StoreModel('test').save_to_db()
                c.put('/item/test', json={'price': 17.99, 'store_id': 1})
                r = c.put('/item/test', json={'price': 18.99, 'store_id': 1})
